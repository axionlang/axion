...
NATIVE=(
  ...
  axionc/tests/fixtures/stdlib_unzip.axi
  axionc/tests/fixtures/either_discard.axi
  ...
  axionc/tests/fixtures/container_copy_reclaim.axi
  axionc/tests/fixtures/tail_borrow_string.axi
...
LEAKFREE=(
  ...
  structural_borrowers_reclaim take_heap_reclaim do_monad_bind either_map_reclaim mixed_param_return_reclaim mixed_param_return_integer container_copy_reclaim tail_borrow_string dead_binding_reclaim sort_heap_reclaim
