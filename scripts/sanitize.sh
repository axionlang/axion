...
LEAKFREE=(
  ...
  nested_drop sum_payload array_thread_let array_thread_do tritvec_roundtrip tritvec_dot tritvec_iota tritvec_matvec i8array_matvec i8array_run array_reduce i8_reduce i32array_run i32_reduce
