...
declare i64 @axion_bignum_copy(i64)
declare i64 @axion_block_copy(i64)
...
declare i64 @axion_sess_run_par(i64, i64, i64)
declare i64 @axion_par_map(i64, i64, i64, i64)
declare void @axion_sess_park_fd(i64, i64, i64)
declare i64 @ax_net_connect(i64, i64)
declare i64 @ax_net_listen(i64)
declare i64 @ax_net_accept(i64)
declare i64 @ax_net_send(i64, i64)
declare i64 @ax_net_recv(i64)
declare i64 @ax_net_close(i64)
declare i64 @ax_net_wouldblock()
declare i64 @ax_net_set_nonblocking(i64)
