 ...
 * MOVED TO RUST (axion-rt, Stage 4a): ax_net_connect/listen/accept/send/recv/close — thin
 * libc TCP wrappers over the fd-based ABI. See docs/rust-runtime-port.md. */
