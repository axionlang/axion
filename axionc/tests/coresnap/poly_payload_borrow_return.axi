...
length xs  =
  ...
  let _d1000000 = field z _t1  ; Δ{_t1}
  ...
  let _dd1 = rtcall axion_free _dd0  ; Δ{}
    ...
    let _dd2 = == _tag 1  ; Δ{}
      let _dd3 = call axion_drop_P _dd2  ; Δ{}
  ...
  let _t0 = call build 3  ; Δ{} · makes List
  ...
  let _t1 = call firstInner _t0  ; Δ{_t0} · moves{_t0} · makes Inner
    ...
    let _t1 = + lo 1  ; Δ{}
        let _t1 = - n 1  ; Δ{}
        let _t1 = - n 1  ; Δ{}
    let _t1 = record Inner { z = n}  ; Δ{} · makes Inner
    ...
    let _t2 = record P { inner = _t1}  ; Δ{_t1} · moves{_t1} · makes P
    let _t3 = - n 1  ; Δ{_t2}
    let _t4 = call build _t3  ; Δ{_t2} · makes List
...
range lo hi  =
  ...
  ret case xs of
    ...
    ret con Cons lo _t2  ; Δ{_t2} · moves{_t2} · makes List
      ...
      ret con Cons _t0 _t1  ; Δ{_t1} · moves{_t1} · makes List
    ret con Cons _t2 _t4  ; Δ{_t2 _t4} · moves{_t2 _t4} · makes List
  ...
  ret if x then
    ret if y then
      ret putStr ""  ; Δ{}
      ret record Inner { z = 0}  ; Δ{} · makes Inner
