...
length xs  =
  ...
  let _t0 = call build 3  ; Δ{} · makes List$Int
  ...
  let _t0 = call map f xs  ; Δ{} · makes List
      ...
      let _t0 = call sum ys  ; Δ{y ys} · moves{ys}
  ...
  let _t0 = <. x y  ; Δ{}
    ...
    let _t2 = + acc lo  ; Δ{}
    let _t2 = call build _t1  ; Δ{} · makes List$Int
...
replicate n x  =
  ...
  ret call sum _t0  ; Δ{_t0} · moves{_t0}
  ret case ab of
  ret case e of
  ret case e of
  ret case e of
  ...
  ret case xs of
    ...
    ret con Cons n _t2  ; Δ{_t2} · moves{_t2} · makes List$Int
