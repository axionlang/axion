...
length xs  =
  ...
  let _t1 = con Cons 2f _t0  ; Δ{_t0} · moves{_t0} · makes List
  ...
  let _t2 = con Cons 7f _t1  ; Δ{_t1} · moves{_t1} · makes List
      let _t2 = con Cons y _t1  ; Δ{_t0 _t1} · moves{_t1} · makes List
  let _t3 = con Cons 3f _t2  ; Δ{_t2} · moves{_t2} · makes List
