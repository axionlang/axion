...
length xs  =
  ...
  let _t2 = closure lam$3  ; Δ{_t0} · makes heap
      let _t2 = con Cons y _t1  ; Δ{_t0 y} · moves{y}
      let _t2 = if _t0 then
      let _t2 = < n 1  ; Δ{}
          let _t3 = callclo p y  ; Δ{}
        let _t3 = call span p ys  ; Δ{}
  let _t3 = closure lam$4  ; Δ{_t0 _t2} · makes heap
        let _t3 = con Nil  ; Δ{}
  let _t4 = call range 1 10  ; Δ{_t0 _t2 _t3} · makes List$Int
            let _t4 = con Cons y l  ; Δ{}
        let _t4 = con Cons y ys  ; Δ{}
        let _t4 = con Nil  ; Δ{}
  let _t5 = call map _t3 _t4  ; Δ{_t0 _t2 _t3 _t4} · makes List$Integer
            let _t5 = con Cons y r  ; Δ{}
        let _t5 = con Cons y ys  ; Δ{}
        let _t5 = - n 1  ; Δ{}
  let _t6 = call map _t2 _t5  ; Δ{_t0 _t2 _t5} · makes List$Integer
        let _t6 = call splitAt _t5 ys  ; Δ{}
  let _t7 = call foldr _t0 _t1 _t6  ; Δ{_t0 _t6}
...
replicate n x  =
  ...
  ret rtcall axion_bignum_from_i64 eta$6  ; Δ{}
  ret rtcall axion_bignum_mul x x  ; Δ{}
