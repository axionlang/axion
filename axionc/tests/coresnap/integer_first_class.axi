      ...
      let _t0 = call sq y  ; Δ{y ys} · makes Integer
      let _t0 = callclo f y  ; Δ{y ys} · moves{y}
      let _t1 = call map$$sq ys  ; Δ{_t0 ys} · moves{ys} · makes List$Integer
  ...
  let _t2 = call range 1 10  ; Δ{_t0 _t1} · makes List$Int
  let _t3 = call map$Int _t1 _t2  ; Δ{_t0 _t1 _t2} · moves{_t2} · makes List$Integer
  let _t4 = call map$$sq _t3  ; Δ{_t0 _t3} · moves{_t3} · makes List$Integer
