...
length xs  =
  ...
  let _t0 = > lo hi  ; Δ{}
      ...
      let _t0 = < n 1  ; Δ{}
  let _t0 = < n 1  ; Δ{}
  let _t0 = rtcall axion_bignum_from_i64 2  ; Δ{}
      let _t0 = == x y  ; Δ{}
  let _t0 = < x y  ; Δ{}
  let _t0 = <. x y  ; Δ{}
    ...
    let _t1 = + lo 1  ; Δ{}
        ...
        let _t1 = - n 1  ; Δ{}
    let _t1 = - n 1  ; Δ{}
  let _t1 = rtcall axion_bignum_from_i64 0  ; Δ{_t0}
  let _t1 = rtcall axion_bignum_lt n _t0  ; Δ{}
  ...
  let _t2 = call replicate 4 20  ; Δ{_t0} · makes List$Int
    let _t2 = call replicate _t1 x  ; Δ{} · makes List
        let _t2 = call take _t1 ys  ; Δ{} · makes List
      let _t2 = con Cons y _t1  ; Δ{_t0 y} · moves{y}
      let _t2 = if _t0 then
      let _t2 = < n 1  ; Δ{}
    let _t2 = rtcall axion_bignum_from_i64 1  ; Δ{}
          let _t3 = callclo p y  ; Δ{}
        let _t3 = call span p ys  ; Δ{}
        let _t3 = con Nil  ; Δ{}
    let _t3 = rtcall axion_bignum_sub n _t2  ; Δ{}
  let _t3 = &worker$step  ; Δ{_t0 _t2}
    let _t4 = call factorial _t3  ; Δ{}
            let _t4 = con Cons y l  ; Δ{}
        let _t4 = con Cons y ys  ; Δ{}
        let _t4 = con Nil  ; Δ{}
  let _t4 = rtcall axion_par_map _t3 48 16 _t2  ; Δ{_t0 _t2} · moves{_t2} · makes List
  let _t5 = call foldr _t0 _t1 _t4  ; Δ{_t0 _t4}
...
replicate n x  =
  ...
  ret rtcall axion_bignum_add a b  ; Δ{}
    ret rtcall axion_bignum_from_i64 1  ; Δ{}
    ret rtcall axion_bignum_mul n _t4  ; Δ{}
