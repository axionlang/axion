...
length xs  =
  ...
  let _t1 = con Cons 2 _t0  ; Δ{_t0} · moves{_t0} · makes List
  ...
  let _t2 = con Cons 1 _t1  ; Δ{_t1} · moves{_t1} · makes List
      let _t2 = con Cons y _t1  ; Δ{_t0 _t1} · moves{_t1} · makes List
  let _t3 = con Nil  ; Δ{_t2} · makes List
  let _t4 = con Cons 4 _t3  ; Δ{_t2 _t3} · moves{_t3} · makes List
  let _t5 = con Cons 3 _t4  ; Δ{_t2 _t4} · moves{_t4} · makes List
  let _t6 = con Nil  ; Δ{_t2 _t5} · makes List
  let _t7 = con Cons 10 _t6  ; Δ{_t2 _t5 _t6} · moves{_t6} · makes List
