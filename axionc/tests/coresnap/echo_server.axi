...
length xs  =
  ...
  let _t0 = closure lam$1  ; Δ{} · makes heap
      let _t0 = con Nil  ; Δ{}
  let _t0 = ffi ax_net_accept sock  ; Δ{}
  ...
  let _t1 = ffi ax_net_recv _t0  ; Δ{}
    let _t1 = + lo 1  ; Δ{}
    let _t1 = + lo 1  ; Δ{}
    let _t1 = + lo 1  ; Δ{}
        let _t1 = - n 1  ; Δ{}
        let _t1 = - n 1  ; Δ{}
  let _t1 = putStrLn "listening on :8080"  ; Δ{}
  ...
  let _t2 = ffi ax_net_send _t0 _t1  ; Δ{}
      let _t2 = if _t0 then
          let _t3 = callclo p y  ; Δ{}
      let _t3 = ffi ax_net_close _t0  ; Δ{}
  ...
  ret callclo f _t0  ; Δ{}
      ...
      ret callclo g y  ; Δ{}
        ret call drop _t1 ys  ; Δ{} · makes List
          ret call echoLoop sock  ; Δ{}
      ret call echoLoop _t0  ; Δ{}
