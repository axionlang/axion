  ...
  let _t1 = call drop$Int 5 _t0  ; Δ{_t0} · moves{_t0} · makes List$Int
  let _t2 = call sum _t1  ; Δ{_t1}
  let _t3 = call range 1 11  ; Δ{} · makes List$Int
  let _t4 = call drop$Int 2 _t3  ; Δ{_t3} · moves{_t3} · makes List$Int
  let _t5 = call sum _t4  ; Δ{_t4}
  let _t6 = + _t2 _t5  ; Δ{}
  let _t7 = call range 1 11  ; Δ{} · makes List$Int
  let _t8 = call drop$Int 0 _t7  ; Δ{_t7} · moves{_t7} · makes List$Int
