...
lam$10 [env ]x  =
lam$11 [env x]eta$24  =
lam$12 [env ]eta$26 eta$27  =
lam$1 [env y]eta$3  =
lam$2 [env ]eta$5 eta$6  =
lam$3 [env ]eta$8 eta$9  =
lam$4 [env ]eta$11 eta$12  =
lam$5 [env ]eta$14 eta$15  =
lam$6 [env ]a b  =
lam$7 [env y]eta$17  =
lam$8 [env ]eta$19 eta$20  =
lam$9 [env x]eta$22  =
le$Bool x y  =
le$Float x y  =
le$Int x y  =
...
length xs  =
      let _d1000000 = call foldl _t0 _t1 ys  ; Δ{_t0}
        let _d1000000 = call incMaybe _t1  ; Δ{_t1} · makes Maybe$Int
          let _d1000000 = call mapM_ _t1 ys  ; Δ{_t0 _t1}
  ...
  let _t0 = closure lam$10  ; Δ{} · makes heap
  let _t0 = closure lam$12  ; Δ{} · makes heap
      let _t0 = closure lam$1 y  ; Δ{} · makes heap
      let _t0 = closure lam$3  ; Δ{} · makes heap
      let _t0 = closure lam$4  ; Δ{} · makes heap
  let _t0 = closure lam$6  ; Δ{} · makes heap
      let _t0 = closure lam$7 y  ; Δ{} · makes heap
  ...
  let _t1 = call map _t0 xs  ; Δ{_t0} · makes List
      ...
      let _t1 = closure lam$2  ; Δ{_t0} · makes heap
          let _t1 = closure lam$5  ; Δ{} · makes heap
          let _t1 = closure lam$8  ; Δ{_t0} · makes heap
      let _t1 = con Nil  ; Δ{}
      let _t1 = con Nil  ; Δ{}
      let _t1 = con Nil  ; Δ{}
  ...
  let _t1 = showInt _t0  ; Δ{} · makes String
    ...
    let _t2 = callclo c lo n  ; Δ{}
      ...
      let _t2 = call map _t1 ys  ; Δ{_t0 _t1} · makes List
...
replicate n x  =
  ...
  ret call f$go m a  ; Δ{}
    ret call f$go m _t1  ; Δ{}
  ret call f eta$11 eta$12  ; Δ{}
  ret call f eta$14 eta$15  ; Δ{}
  ret call f eta$19 eta$20  ; Δ{}
  ret call f eta$26 eta$27  ; Δ{}
  ret call f eta$5 eta$6  ; Δ{}
  ret call f eta$8 eta$9  ; Δ{}
        ret call filter p ys  ; Δ{} · makes List
        ret call find p ys  ; Δ{} · makes Maybe
  ret call f _t0 eta$1  ; Δ{}
  ret call f x eta$22  ; Δ{}
  ret call f x eta$24  ; Δ{}
  ret call f y eta$17  ; Δ{}
  ret call f y eta$3  ; Δ{}
      ret call f y _t1  ; Δ{}
  ...
  ret case xs of
      ret case y of
      ret case ys of
  ret closure lam$0 g x  ; Δ{} · makes heap
      ret closure lam$11 x  ; Δ{} · makes heap
      ret closure lam$9 x  ; Δ{} · makes heap
    ret con Cons lo _t2  ; Δ{_t2} · moves{_t2} · makes List$Int
        ret con Cons sep _t1  ; Δ{_t1 y} · moves{_t1}
      ret con Cons _t0 _t2  ; Δ{_t0 _t2} · moves{_t0 _t2}
