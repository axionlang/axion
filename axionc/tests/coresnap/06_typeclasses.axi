...
length xs  =
  ...
  let _t0 = < x y  ; Δ{}
  let _t0 = <. x y  ; Δ{}
  let _t10 = con Cons _t2 _t9  ; Δ{_t9} · moves{_t9} · makes List
  let _t11 = con Cons _t1 _t10  ; Δ{_t10} · moves{_t10} · makes List
  let _t12 = call count$Color _t0 _t11  ; Δ{_t11}
  let _t13 = con Nil  ; Δ{} · makes List
  let _t14 = con Cons 7 _t13  ; Δ{_t13} · moves{_t13} · makes List
  let _t15 = con Cons 7 _t14  ; Δ{_t14} · moves{_t14} · makes List
  let _t16 = con Cons 1 _t15  ; Δ{_t15} · moves{_t15} · makes List
  let _t17 = con Cons 7 _t16  ; Δ{_t16} · moves{_t16} · makes List
  ...
  let _t7 = con Cons _t5 _t6  ; Δ{_t6} · moves{_t6} · makes List
  let _t8 = con Cons _t4 _t7  ; Δ{_t7} · moves{_t7} · makes List
  let _t9 = con Cons _t3 _t8  ; Δ{_t8} · moves{_t8} · makes List
