...
length xs  =
  ...
  let _t0 = < x y  ; Δ{}
  let _t0 = <. x y  ; Δ{}
  let _t10 = con Cons 4 _t9  ; Δ{_t8 _t9} · moves{_t9} · makes List
  let _t11 = con Cons 3 _t10  ; Δ{_t10 _t8} · moves{_t10} · makes List
  let _t12 = call append _t8 _t11  ; Δ{_t11 _t8} · moves{_t11} · makes List
  let _t13 = call sum _t12  ; Δ{_t12}
  let _t14 = + _t5 _t13  ; Δ{}
  let _t15 = con Nil  ; Δ{} · makes List
  let _t16 = con Cons 30 _t15  ; Δ{_t15} · moves{_t15} · makes List
  let _t17 = con Cons 20 _t16  ; Δ{_t16} · moves{_t16} · makes List
  let _t18 = con Cons 10 _t17  ; Δ{_t17} · moves{_t17} · makes List
  ...
  let _t1 = con Cons 4 _t0  ; Δ{_t0} · moves{_t0} · makes List
  ...
  let _t23 = con Nil  ; Δ{_t22} · makes List
  let _t24 = con Cons 3 _t23  ; Δ{_t22 _t23} · moves{_t23} · makes List
  let _t25 = con Cons 2 _t24  ; Δ{_t22 _t24} · moves{_t24} · makes List
  let _t26 = con Cons 1 _t25  ; Δ{_t22 _t25} · moves{_t25} · makes List
  ...
  let _t2 = con Cons 3 _t1  ; Δ{_t1} · moves{_t1} · makes List
      let _t2 = con Cons y _t1  ; Δ{_t0 _t1} · moves{_t1} · makes List
  let _t30 = con Nil  ; Δ{_t29} · makes List
  let _t31 = con Cons 6 _t30  ; Δ{_t29 _t30} · moves{_t30} · makes List
  let _t32 = con Cons 5 _t31  ; Δ{_t29 _t31} · moves{_t31} · makes List
  let _t33 = con Cons 4 _t32  ; Δ{_t29 _t32} · moves{_t32} · makes List
  let _t34 = call foldl _t29 0 _t33  ; Δ{_t29 _t33} · moves{_t29}
  let _t35 = + _t28 _t34  ; Δ{}
  let _t36 = con Nil  ; Δ{} · makes List
  let _t37 = con Cons 300 _t36  ; Δ{_t36} · moves{_t36} · makes List
  let _t38 = con Cons 200 _t37  ; Δ{_t37} · moves{_t37} · makes List
  let _t39 = con Cons 100 _t38  ; Δ{_t38} · moves{_t38} · makes List
  let _t3 = con Cons 2 _t2  ; Δ{_t2} · moves{_t2} · makes List
  let _t40 = call take 2 _t39  ; Δ{_t39} · makes List
  let _t41 = call sum _t40  ; Δ{_t40}
  let _t42 = + _t35 _t41  ; Δ{}
  let _t43 = con Nil  ; Δ{} · makes List
  let _t44 = con Cons 3 _t43  ; Δ{_t43} · moves{_t43} · makes List
  let _t45 = con Cons 2 _t44  ; Δ{_t44} · moves{_t44} · makes List
  let _t46 = con Cons 1 _t45  ; Δ{_t45} · moves{_t45} · makes List
  let _t47 = call drop 1 _t46  ; Δ{_t46} · makes List
  let _t48 = call sum _t47  ; Δ{_t47}
  let _t49 = + _t42 _t48  ; Δ{}
  let _t4 = con Cons 1 _t3  ; Δ{_t3} · moves{_t3} · makes List
  let _t50 = closure lam$3  ; Δ{} · makes heap
  let _t51 = con Nil  ; Δ{_t50} · makes List
  let _t52 = con Cons 6 _t51  ; Δ{_t50 _t51} · moves{_t51} · makes List
  let _t53 = con Cons 5 _t52  ; Δ{_t50 _t52} · moves{_t52} · makes List
  let _t54 = con Cons 4 _t53  ; Δ{_t50 _t53} · moves{_t53} · makes List
  let _t55 = con Cons 3 _t54  ; Δ{_t50 _t54} · moves{_t54} · makes List
  let _t56 = con Cons 2 _t55  ; Δ{_t50 _t55} · moves{_t55} · makes List
  let _t57 = con Cons 1 _t56  ; Δ{_t50 _t56} · moves{_t56} · makes List
  ...
  let _t61 = con Nil  ; Δ{} · makes List
  let _t62 = call null _t61  ; Δ{_t61}
  let _t63 = call b2i _t62  ; Δ{}
  let _t64 = + _t60 _t63  ; Δ{}
  let _t65 = con Nil  ; Δ{} · makes List
  let _t66 = con Cons 3 _t65  ; Δ{_t65} · moves{_t65} · makes List
  let _t67 = con Cons 2 _t66  ; Δ{_t66} · moves{_t66} · makes List
  let _t68 = con Cons 1 _t67  ; Δ{_t67} · moves{_t67} · makes List
  let _t69 = call elem 3 _t68  ; Δ{_t68}
  let _t6 = con Nil  ; Δ{} · makes List
  let _t70 = call b2i _t69  ; Δ{}
  let _t7 = con Cons 2 _t6  ; Δ{_t6} · moves{_t6} · makes List
  let _t8 = con Cons 1 _t7  ; Δ{_t7} · moves{_t7} · makes List
  let _t9 = con Nil  ; Δ{_t8} · makes List
