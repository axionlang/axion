...
length xs  =
  ...
  let _t0 = closure lam$0  ; Δ{} · makes heap
      let _t0 = con Nil  ; Δ{xs} · makes List
  let _t0 = > lo hi  ; Δ{}
  let _t0 = == n 0  ; Δ{}
      let _t0 = < n 1  ; Δ{}
      let _t0 = < n 1  ; Δ{}
  ...
  let _t0 = <. x y  ; Δ{}
      ...
      let _t1 = call probe$P _t0  ; Δ{_t0 xs} · moves{_t0}
    ...
    let _t2 = - n 1  ; Δ{_t1}
    let _t3 = call build _t2  ; Δ{_t1} · makes List
...
range lo hi  =
  ...
  ret call wipe$P _t0  ; Δ{_t0} · moves{_t0}
  ...
  ret case xs of
    ...
    ret con Cons lo _t2  ; Δ{_t2} · moves{_t2} · makes List
      ...
      ret con Cons _t0 _t1  ; Δ{_t1} · moves{_t1} · makes List
    ret con Cons _t1 _t3  ; Δ{_t1 _t3} · moves{_t1 _t3} · makes List
