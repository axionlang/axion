...
length xs  =
    ...
    let _d1000000 = call eq$Maybe$Int _t3 _t4  ; Δ{_t3 _t4}
  ...
  let _t0 = con None  ; Δ{} · makes Maybe$Int
  let _t0 = > lo hi  ; Δ{}
  let _t0 = > lo hi  ; Δ{}
      let _t0 = < n 1  ; Δ{}
      let _t0 = < n 1  ; Δ{}
  ...
  let _t1 = con Some 3  ; Δ{_t0} · makes Maybe$Int
    let _t1 = + lo 1  ; Δ{}
    let _t1 = + lo 1  ; Δ{}
        let _t1 = - n 1  ; Δ{}
        let _t1 = - n 1  ; Δ{}
  ...
  let _t2 = call le$Maybe$Int _t0 _t1  ; Δ{_t0 _t1}
    ...
    let _t3 = con Some 5  ; Δ{} · makes Maybe$Int
    let _t4 = con Some 5  ; Δ{_t3} · makes Maybe$Int
