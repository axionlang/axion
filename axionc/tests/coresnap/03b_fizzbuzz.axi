...
length xs  =
  ...
  let _d1000000 = call compose _t0 _t1 eta$5  ; Δ{_t0 _t1}
  let _d1000000 = call concat _t0  ; Δ{_t0} · makes List
  let _d1000000 = call mapM_ _t0 _t1  ; Δ{_t0 _t1} · moves{_t0}
  ...
  let _t1 = call range 1 15  ; Δ{_t0} · makes List$Int
          let _t1 = call zipWith f as_ bs  ; Δ{} · makes List
  let _t1 = closure lam$4  ; Δ{_t0} · makes heap
      let _t1 = con Nil  ; Δ{}
