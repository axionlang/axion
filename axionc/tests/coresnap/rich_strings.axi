...
length xs  =
  ...
  let _t4 = con Nil  ; Δ{} · makes List$String
  let _t5 = con Cons "line 2" _t4  ; Δ{_t4} · moves{_t4} · makes List$String
            let _t5 = con Cons y r  ; Δ{}
  let _t6 = con Cons "line 1" _t5  ; Δ{_t5} · moves{_t5} · makes List$String
