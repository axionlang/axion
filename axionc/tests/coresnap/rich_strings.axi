...
length xs  =
  ...
  let _t1 = con Cons "Axion" _t0  ; Δ{_t0} · moves{_t0} · makes List
  ...
  let _t2 = con Cons "Hello" _t1  ; Δ{_t1} · moves{_t1} · makes List
      let _t2 = con Cons y _t1  ; Δ{_t0 _t1} · moves{_t1} · makes List
  let _t3 = call unwords _t2  ; Δ{_t2}
  let _t4 = con Nil  ; Δ{} · makes List
  let _t5 = con Cons "line 2" _t4  ; Δ{_t4} · moves{_t4} · makes List
  let _t6 = con Cons "line 1" _t5  ; Δ{_t5} · moves{_t5} · makes List
  let _t7 = call unlines _t6  ; Δ{_t6}
  let _t8 = rtcall axion_strcat "!\n" _t7  ; Δ{}
  let _t9 = rtcall axion_strcat _t3 _t8  ; Δ{}
