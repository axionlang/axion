                      ...
                      let _t34 = call last$Int _t33  ; Δ{_t33} · moves{_t33} · makes Maybe$Int
                  ...
                  let _t28 = call drop$Int 5 _t27  ; Δ{_t27} · moves{_t27} · makes List$Int
                  let _t29 = call head$Int _t28  ; Δ{_t28} · moves{_t28} · makes Maybe$Int
              ...
              let _t24 = call last$Int _t23  ; Δ{_t23} · moves{_t23} · makes Maybe$Int
          ...
          ret call last$Int _t0  ; Δ{y} · makes Maybe$Int
          ret case _t19 of
      ...
      let _t10 = call head$Int _t9  ; Δ{_t9} · moves{_t9} · makes Maybe$Int
