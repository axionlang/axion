      ...
      drop xs : List$Int
      drop y : Integer
      let _d1000000 = call const0 y _t0  ; Δ{_t0 y} · makes Integer
      ...
      let _t0 = call foldr$$const0 z ys  ; Δ{y ys} · moves{ys} · makes Integer
  ...
  let _t4 = call foldr$$const0 _t0 _t3  ; Δ{_t0 _t3} · moves{_t0 _t3} · makes Integer
