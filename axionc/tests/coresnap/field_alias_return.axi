  ...
  let _d1000000 = call useW _t5  ; Δ{_t5}
  ...
  let _t4 = con Cons 9 _t3  ; Δ{_t2 _t3} · moves{_t3} · makes List$Int
  let _t5 = record W { inner = _t2 other = _t4}  ; Δ{_t2 _t4} · moves{_t2 _t4} · makes W
  ret 0  ; Δ{}
  ret 0  ; Δ{}
  ret 0  ; Δ{}
  ret _d1000000  ; Δ{}
