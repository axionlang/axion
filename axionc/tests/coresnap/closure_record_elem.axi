      ...
      let _t0 = call getV y  ; Δ{y ys} · makes Integer
      let _t0 = call mkR y  ; Δ{y ys} · moves{y} · makes R
      let _t0 = callclo f y  ; Δ{y ys} · moves{y}
      let _t1 = call map$$getV ys  ; Δ{_t0 ys} · moves{ys} · makes List$Integer
      let _t1 = call map$$mkR ys  ; Δ{_t0 ys} · moves{ys} · makes List$R
      ...
      ret con Cons _t0 _t1  ; Δ{_t0 _t1} · moves{_t0 _t1} · makes List$R
      ret con Cons _t0 _t1  ; Δ{_t1} · moves{_t1}
      ret con Nil  ; Δ{}
      ret con Nil  ; Δ{} · makes List$Integer
      ret con Nil  ; Δ{} · makes List$R
      ret z  ; Δ{}
    Cons y ys ->
    Cons y ys ->
    Cons y ys ->
  ...
  let _t4 = call map$$mkR _t3  ; Δ{_t0 _t3} · moves{_t3} · makes List$R
  let _t5 = call map$$getV _t4  ; Δ{_t0 _t4} · moves{_t4} · makes List$Integer
