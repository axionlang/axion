...
le$Int x y  =
    ...
    Left x ->
length xs  =
        let _d1000000 = call incMaybe _t2  ; Δ{_t2} · makes Maybe$Int
  ...
  let _t1 = rtcall axion_bignum_from_i64 3120  ; Δ{}
    ...
    let _t2 = callclo c lo n  ; Δ{}
        let _t2 = call filter p ys  ; Δ{} · makes List
        let _t2 = call findIndex p ys  ; Δ{} · makes Maybe$Int
  let _t2 = call modInverse _t0 _t1  ; Δ{}
    ...
    let _t2 = call replicate _t1 x  ; Δ{} · makes List
        ...
        let _t2 = call takeWhile p ys  ; Δ{} · makes List
  ...
  let _t3 = call show$Integer _t2  ; Δ{} · makes String
    ...
    let _t3 = rtcall axion_bignum_mod e _t2  ; Δ{}
          let _t4 = callclo _t3 y  ; Δ{}
        let _t4 = call span p ys  ; Δ{}
    ...
    let _t5 = rtcall axion_bignum_sub t _t4  ; Δ{}
      let _t6 = call show$Integer _t5  ; Δ{} · makes String
        let _t6 = call splitAt _t5 ys  ; Δ{}
            let _t6 = con Cons y r  ; Δ{}
        let _t6 = con Cons y ys  ; Δ{}
