...
length xs  =
  ...
  let _d1000000 = putStrLn _t1  ; Δ{_t1}
      ...
      let _d1000001 = rtcall axion_strcat _t10 ")"  ; Δ{_t10} · makes String
      let _d1000001 = rtcall axion_strcat _t5 _t6  ; Δ{_t5 _t6} · makes String
  ...
  let _t0 = > lo hi  ; Δ{}
      ...
      let _t0 = < n 1  ; Δ{}
  let _t0 = < n 1  ; Δ{}
      let _t0 = rtcall axion_strcat "Circle" " "  ; Δ{} · makes String
      let _t0 = rtcall axion_strcat "Circle" " "  ; Δ{} · makes String
      let _t0 = tuple y ys  ; Δ{y ys} · moves{y ys} · makes heap
      let _t0 = == x y  ; Δ{}
  let _t0 = < x y  ; Δ{}
  let _t0 = <. x y  ; Δ{}
      let _t10 = rtcall axion_strcat "(" _t9  ; Δ{_t9} · makes String
  ...
  let _t1 = call show$Shape _t0  ; Δ{_t0} · makes String
    ...
    let _t2 = call replicate _t1 x  ; Δ{} · makes List
      ...
      let _t2 = if _t0 then
      let _t2 = < n 1  ; Δ{}
      let _t2 = rtcall axion_strcat "Rect" " "  ; Δ{} · makes String
      let _t2 = rtcall axion_strcat _t0 _t1  ; Δ{_t0 _t1} · makes String
          let _t3 = callclo p y  ; Δ{}
      let _t3 = call showArg$Int a0  ; Δ{_t2} · makes String
      ...
      let _t3 = rtcall axion_strcat "(" _t2  ; Δ{_t2} · makes String
        ...
        let _t4 = con Nil  ; Δ{}
      let _t4 = rtcall axion_strcat "Rect" " "  ; Δ{} · makes String
      let _t4 = rtcall axion_strcat _t2 _t3  ; Δ{_t2 _t3} · makes String
      let _t5 = call showArg$Int a0  ; Δ{_t4} · makes String
            let _t5 = con Cons y r  ; Δ{}
        let _t5 = con Cons y ys  ; Δ{}
        let _t5 = - n 1  ; Δ{}
      let _t5 = rtcall axion_strcat _t4 " "  ; Δ{_t4} · makes String
      let _t6 = call showArg$Int a1  ; Δ{_t5} · makes String
      ...
      let _t8 = call showArg$Int a1  ; Δ{_t7} · makes String
      let _t9 = rtcall axion_strcat _t7 _t8  ; Δ{_t7 _t8} · makes String
