        ...
        drop y : Integer
        drop ys : List$Integer
        let _t1 = - n 1  ; Δ{y ys}
        let _t2 = call take$Integer _t1 ys  ; Δ{y ys} · moves{ys} · makes List$Integer
  ...
  let _t4 = call take$Integer 3 _t3  ; Δ{_t0 _t3} · moves{_t3} · makes List$Integer
