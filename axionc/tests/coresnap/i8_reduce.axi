...
length xs  =
  ...
  let _t0 = <. x y  ; Δ{}
    ...
    let _t1 = + lo 1  ; Δ{}
        ...
        let _t1 = - n 1  ; Δ{}
    let _t1 = - n 1  ; Δ{}
  let _t1 = rtcall axion_i8_sum _t0  ; Δ{_t0}
  ...
  let _t2 = * _t1 100  ; Δ{}
        ...
        let _t3 = con Nil  ; Δ{}
  let _t3 = rtcall axion_i8_iota 10  ; Δ{} · makes I8Array
            let _t4 = con Cons y l  ; Δ{}
        let _t4 = con Cons y ys  ; Δ{}
        let _t4 = con Nil  ; Δ{}
  let _t4 = rtcall axion_array_iota 10  ; Δ{_t3} · makes Array
            let _t5 = con Cons y r  ; Δ{}
        let _t5 = con Cons y ys  ; Δ{}
        let _t5 = - n 1  ; Δ{}
  let _t5 = rtcall axion_i8_dot _t3 _t4  ; Δ{_t3 _t4}
