...
length xs  =
  ...
  let _t1 = con Cons 3 _t0  ; Δ{_t0} · moves{_t0} · makes List
  ...
  let _t3 = con Cons 1 _t2  ; Δ{_t2} · moves{_t2} · makes List
  let _t4 = call sumList _t3  ; Δ{_t3}
  let _t5 = closure lam$1  ; Δ{} · makes heap
  let _t6 = call range 1 4  ; Δ{_t5} · makes List
  let _t7 = call map _t5 _t6  ; Δ{_t5 _t6} · moves{_t5} · makes List
