...
length xs  =
  ...
  let _d1000000 = call countNeq$Int 2 _t5  ; Δ{_t5}
  ...
  let _t0 = < x y  ; Δ{}
  let _t0 = <. x y  ; Δ{}
        let _t1 = call countNeq$Int x ys  ; Δ{}
  ...
  let _t4 = con Cons 2 _t3  ; Δ{_t3} · moves{_t3} · makes List
