-- Buffer %1 linear + mutação in-place (§5, estilo exemplo 03). 'encrypt'
-- consome o Buffer %1 e devolve a posse (XOR in-place) — um único fio linear
-- b0→b1→b2→free, nunca clonado. sum de ((i&0xFF) ^ 90) para i em 0..1000.
encrypt :: Buffer %1 -> Buffer %1
